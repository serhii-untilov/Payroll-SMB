...
RBAC - Обмеження доступу користувачів до операцій над сутностями (таблицями) відповідно до ролі користувача.
...
## Шаблон доступу до довідників (simple resource)
...
## Шаблон доступу до таблиць обліку (full-future resource)
