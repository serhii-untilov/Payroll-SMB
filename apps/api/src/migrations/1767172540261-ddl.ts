...
export class Ddl1767172540261 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "work_time_norm_days" (
                ...
                "deleted_user_id" bigint,
                "version" integer NOT NULL DEFAULT '1',
                "work_time_norm_id" bigint NOT NULL,
                "day" integer NOT NULL,
                "hours" numeric(5, 2) NOT NULL,
                CONSTRAINT "PK_db9a0fc509211e26226013628c8" PRIMARY KEY ("id")
            )
        `);
        await queryRunner.query(`
            CREATE TABLE "roles" (
        ...
        `);
        await queryRunner.query(`
            CREATE TABLE "pay_period_summaries" (
                "id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL,
                "pay_period_id" bigint NOT NULL,
                "calc_method" character varying(30) NOT NULL,
                "fact_sum" numeric(15, 2) NOT NULL DEFAULT '0',
                CONSTRAINT "PK_dcaf55aac68cce0a91a23b4c266" PRIMARY KEY ("id")
            )
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "work_time_norm_days"
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "fk_position_history_position_id_positions" FOREIGN KEY ("position_id") REFERENCES "positions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "pay_period_summaries"
            ADD CONSTRAINT "fk_pay_period_summaries_pay_period_id_pay_periods" FOREIGN KEY ("pay_period_id") REFERENCES "pay_periods"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP TABLE "pay_period_summaries"
        `);
        await queryRunner.query(`
