...
export class Gen1719230330365 implements MigrationInterface {
    name = 'Gen1719230330365';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE "payment" (
                ...
                "grossPay" numeric(6, 2) NOT NULL DEFAULT '0',
                "deductions" numeric(6, 2) NOT NULL DEFAULT '0',
                "netPay" numeric(6, 2) NOT NULL DEFAULT '0',
