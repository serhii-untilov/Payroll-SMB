...
const recordList = [
    ...
    },
    {
        ...
        calcMethod: CalcMethod.PaidVacation,
        description: {
    ...
    },
    {
        ...
        paymentPart: PaymentPart.Accruals,
        paymentGroup: PaymentGroup.Vacations,
        calcMethod: CalcMethod.UnpaidLeave,
        description: {
    ...
    },
    {
        ...
        calcMethod: CalcMethod.PaidSickByCompany,
        description: {
    ...
    },
    {
        ...
        paymentPart: PaymentPart.Accruals,
        paymentGroup: PaymentGroup.Sicks,
        calcMethod: CalcMethod.PaidSickBySif,
        description: {
    ...
    },
    {
        ...
        paymentPart: PaymentPart.Accruals,
        paymentGroup: PaymentGroup.Sicks,
        calcMethod: CalcMethod.UnconfirmedSick,
        description: {
    ...
    },
    {
        ...
        calcMethod: CalcMethod.IncomeIndexation,
        description: {
    ...
    },
    {
        ...
        calcMethod: CalcMethod.IncomeTax,
        description: {
    ...
    },
    {
        ...
        paymentPart: PaymentPart.Deductions,
        paymentGroup: PaymentGroup.Taxes,
        calcMethod: CalcMethod.MilitaryTax,
        description: {
    ...
    },
    {
        ...
        calcMethod: CalcMethod.AdvancedPayment,
        description: {
    ...
    },
    {
        ...
        paymentPart: PaymentPart.Deductions,
        paymentGroup: PaymentGroup.Payments,
        calcMethod: CalcMethod.RegularPayment,
        description: {
