...
export default async () => {
    const t = {
        ['./types/lib/field']: await import('./types/lib/field'),
        ['./types/lib/role-type']: await import('./types/lib/role-type'),
        ['./types/lib/accounting-type']: await import('./types/lib/accounting-type'),
        ['./resources/company/entities/company.entity']: await import('./resources/company/entities/company.entity'),
        ['./resources/department/entities/department.entity']: await import(
            './resources/department/entities/department.entity'
        ),
        ['./types/lib/gender']: await import('./types/lib/gender'),
        ...
        ['./resources/job/entities/job.entity']: await import('./resources/job/entities/job.entity'),
        ...
        ['./resources/user-role/entities/user-role.entity']: await import(
        ...
        ['./resources/role/entities/role.entity']: await import('./resources/role/entities/role.entity'),
        ['./types/lib/resource']: await import('./types/lib/resource'),
        ['./types/lib/action']: await import('./types/lib/action'),
        ['./resources/user-access/dto/action-context.dto']: await import(
            './resources/user-access/dto/action-context.dto'
        ),
        ['./resources/common/dto/lookup.dto']: await import('./resources/common/dto/lookup.dto'),
        ['./resources/common/dto/page-meta.dto']: await import('./resources/common/dto/page-meta.dto'),
        ...
        ['./resources/person/dto/person-search.dto']: await import('./resources/person/dto/person-search.dto'),
        ['./resources/person/dto/person-filters.dto']: await import('./resources/person/dto/person-filters.dto'),
        ['./resources/common/dto/sorting.dto']: await import('./resources/common/dto/sorting.dto'),
        ['./resources/common/dto/page.dto']: await import('./resources/common/dto/page.dto'),
        ...
        ['./types/lib/audit-action']: await import('./types/lib/audit-action'),
        ['./resources/company/dto/list-companies.dto']: await import('./resources/company/dto/list-companies.dto'),
        ['./resources/company/dto/company-read.dto']: await import('./resources/company/dto/company-read.dto'),
        ['./resources/user/dto/public-user-data.dto']: await import('./resources/user/dto/public-user-data.dto'),
        ['./resources/department/dto/list-departments.dto']: await import(
            './resources/department/dto/list-departments.dto'
        ),
        ['./resources/department/dto/department-read.dto']: await import(
            './resources/department/dto/department-read.dto'
        ),
        ['./resources/job/dto/list-jobs.dto']: await import('./resources/job/dto/list-jobs.dto'),
        ['./resources/job/dto/job-read.dto']: await import('./resources/job/dto/job-read.dto'),
        ...
        ['./resources/common/dto/id.dto']: await import('./resources/common/dto/id.dto'),
        ['./resources/person/dto/person-read.dto']: await import('./resources/person/dto/person-read.dto'),
        ['./resources/person/dto/list-persons.dto']: await import('./resources/person/dto/list-persons.dto'),
    ...
    return {
        '@nestjs/swagger': {
            models: [
                ...
                [
                    import('./resources/user-access/dto/action-context.dto'),
                    {
                        ActionContextDto: {
                            companyId: { required: false, type: () => String },
                            resourceId: { required: false, type: () => String },
                            field: { required: false, enum: t['./types/lib/field'].Field },
                        },
                    },
                ],
                [
                ...
                [import('./resources/user-role/dto/update-user-role.dto'), { UpdateUserRoleDto: {} }],
                [
                ...
                [
                    import('./resources/department/entities/department.entity'),
                    {
                        DepartmentEntity: {
                            ...
                            company: {
                                required: false,
                                type: () => t['./resources/company/entities/company.entity'].CompanyEntity,
                            },
                            companyId: { required: true, type: () => String },
                            ...
                            parentDepartment: {
                                required: false,
                                type: () => t['./resources/department/entities/department.entity'].DepartmentEntity,
                                nullable: true,
                            },
                ...
                [
                    import('./resources/person/dto/create-person.dto'),
                    {
                        CreatePersonDto: {
                            firstName: { required: true, type: () => String },
                            lastName: { required: true, type: () => String },
                            middleName: { required: false, type: () => String, nullable: true },
                            birthDate: { required: false, type: () => Date, nullable: true },
                            taxId: { required: true, type: () => String },
                            gender: { required: false, nullable: true },
                ...
                [
                    import('./resources/person/dto/person-list-item.dto'),
                    {
                        PersonListItemDto: {
                            id: { required: true, type: () => String },
                            firstName: { required: true, type: () => String },
                            lastName: { required: true, type: () => String },
                            middleName: { required: true, type: () => String, nullable: true },
                            fullName: { required: true, type: () => String },
                            birthDate: { required: true, type: () => Date, nullable: true },
                            taxId: { required: true, type: () => String, nullable: true },
                            gender: { required: true, nullable: true, enum: t['./types/lib/gender'].Gender },
                ...
                [
                    import('./resources/person/dto/person-read.dto'),
                    {
                        PersonReadDto: {
                            id: { required: true, type: () => String },
                            firstName: { required: true, type: () => String },
                ...
                [
                    import('./resources/person/entities/person.entity'),
                    {
                        PersonEntity: {
                            ...
                            phone: { required: true, type: () => String, nullable: true },
                            email: { required: true, type: () => String, nullable: true },
                            photo: { required: true, type: () => String, nullable: true },
                            positions: {
                                required: false,
                ...
                [
                    ...
                    { JobEntity: { name: { required: true, type: () => String } } },
                ],
                [
                ...
                [
                    import('./resources/position-history/entities/position-history.entity'),
                    {
                        PositionHistory: {
                            ...
                            job: { required: false, type: () => t['./resources/job/entities/job.entity'].JobEntity },
                ...
                [
                    import('./resources/company/entities/company.entity'),
                    {
                        CompanyEntity: {
                            ...
                            lawId: { required: true, type: () => String, nullable: true },
                            accounting: {
                                required: false,
                                type: () => t['./resources/accounting/entities/accounting.entity'].Accounting,
                            },
                            accountingId: { required: true, type: () => String, nullable: true },
                            paymentSchedule: {
                                required: true,
                            ...
                            users: {
                                required: false,
                                type: () => [t['./resources/user-role/entities/user-role.entity'].UserRole],
                            },
                        },
                    },
                ],
                [
                    import('./resources/user-role/entities/user-role.entity'),
                    {
                        UserRole: {
                            ...
                            userId: { required: true, type: () => String },
                            role: { required: false, type: () => t['./resources/role/entities/role.entity'].Role },
                            roleId: { required: true, type: () => String },
                            company: {
                                required: false,
                                type: () => t['./resources/company/entities/company.entity'].CompanyEntity,
                ...
                [
                    import('./resources/user-access/dto/access-check.dto'),
                    {
                        CanUserDto: {
                            userId: { required: true, type: () => String },
                            ...
                            context: {
                                required: false,
                                type: () => t['./resources/user-access/dto/action-context.dto'].ActionContextDto,
                            },
                        },
                    },
                ],
                [import('./resources/common/base/user-access.abstract'), { BaseUserAccess: {} }],
                [
                    import('./resources/common/dto/page.dto'),
                    {
                        PageDto: {
                            page: { required: true, type: () => Number, default: 1, minimum: 1 },
                            limit: { required: true, type: () => Number, default: 20, minimum: 1 },
                        },
                    },
                ],
                [
                    import('./resources/common/dto/sorting.dto'),
                    {
                        SortingDto: {
                ...
                [
                    import('./resources/common/dto/lookup.dto'),
                    {
                        LookupRequestDto: {
                        ...
                        LookupResponseDto: {
                            rows: {
                                required: true,
                                type: () => [t['./resources/common/dto/lookup.dto'].LookupItemDto],
                            },
                        },
                    },
                ],
                [import('./resources/common/dto/id.dto'), { IdDto: { id: { required: true, type: () => String } } }],
                [import('./resources/role/dto/create-role.dto'), { CreateRoleDto: {} }],
                [import('./resources/role/dto/update-role.dto'), { UpdateRoleDto: {} }],
                [
                    import('./resources/company/dto/company-read.dto'),
                    {
                        CompanyReadDto: {
                            id: { required: true, type: () => String },
                            name: { required: true, type: () => String },
                            taxId: { required: true, type: () => String, nullable: true },
                            lawId: { required: true, type: () => String, nullable: true },
                            lawName: { required: true, type: () => String },
                            accountingId: { required: true, type: () => String, nullable: true },
                            accountingName: { required: true, type: () => String },
                            paymentSchedule: {
                                required: true,
                                nullable: true,
                                enum: t['./types/lib/payment-schedule'].PaymentSchedule,
                ...
                [
                    import('./resources/company/dto/create-company.dto'),
                    {
                        CreateCompanyDto: {
                            name: { required: true, type: () => String },
                            taxId: { required: false, type: () => String },
                            lawId: { required: false, type: () => String },
                            accountingId: { required: false, type: () => String },
                            paymentSchedule: {
                                required: false,
                                enum: t['./types/lib/payment-schedule'].PaymentSchedule,
                            },
                            dateFrom: { required: false, type: () => Date },
                            dateTo: { required: false, type: () => Date },
                            payPeriod: { required: false, type: () => Date },
                            checkDate: { required: false, type: () => Date },
                        },
                    },
                ],
                [
                    import('./resources/company/dto/company-search.dto'),
                    {
                        CompanySearchDto: {
                ...
                [
                    import('./resources/company/dto/company-filters.dto'),
                    {
                        CompanyFiltersDto: {
                            payPeriod: { required: false },
                            lawId: { required: false, type: () => [String] },
                            accountingId: { required: false, type: () => [String] },
                            paymentSchedule: {
                                required: false,
                ...
                [import('./resources/company/dto/list-companies-query.dto'), { ListCompaniesQueryDto: {} }],
                [
                    import('./resources/common/dto/page-meta.dto'),
                    {
                        PageMetaDto: {
                ...
                [
                    import('./resources/common/dto/list-response.dto'),
                    {
                        ListResponseDto: {
                            items: { required: true },
                            page: { required: true, type: () => t['./resources/common/dto/page-meta.dto'].PageMetaDto },
                        },
                    },
                ],
                [import('./resources/company/dto/company-list-item.dto'), { CompanyListItemDto: {} }],
                [import('./resources/company/dto/list-companies.dto'), { ListCompaniesDto: {} }],
                ...
                [
                    import('./resources/department/dto/create-department.dto'),
                    {
                        CreateDepartmentDto: {
                            name: { required: true, type: () => String },
                            companyId: { required: true, type: () => String },
                ...
                [
                    import('./resources/department/dto/department-read.dto'),
                    {
                        DepartmentReadDto: {
                            id: { required: true, type: () => String },
                            name: { required: true, type: () => String },
                            companyId: { required: true, type: () => String },
                            companyName: { required: true, type: () => Object },
                            dateFrom: { required: true, type: () => Date },
                            dateTo: { required: true, type: () => Date },
                            parentDepartmentId: { required: true, type: () => Object },
                            parentDepartmentName: { required: true, type: () => Object },
                            version: { required: true, type: () => Number },
                        },
                    },
                ],
                [
                    import('./resources/department/dto/department-filters.dto'),
                    {
                        DepartmentFiltersDto: {
                            dateFrom: { required: false },
                            companyId: { required: false, type: () => [String] },
                            parentDepartmentId: { required: false, type: () => [String] },
                        },
                    },
                ],
                [
                    import('./resources/department/dto/department-search.dto'),
                    { DepartmentSearchDto: { name: { required: false, type: () => String } } },
                ],
                [import('./resources/department/dto/list-departments-query.dto'), { ListDepartmentsQueryDto: {} }],
                [import('./resources/department/dto/department-list-item.dto'), { DepartmentListItemDto: {} }],
                [import('./resources/department/dto/list-departments.dto'), { ListDepartmentsDto: {} }],
                ...
                [
                    import('./resources/job/dto/job-read.dto'),
                    {
                        JobReadDto: {
                            id: { required: true, type: () => String },
                            name: { required: true, type: () => String },
                ...
                [
                    import('./resources/job/dto/job-search.dto'),
                    { JobSearchDto: { name: { required: false, type: () => String } } },
                ],
                [import('./resources/job/dto/list-jobs-query.dto'), { ListJobsQueryDto: {} }],
                [import('./resources/job/dto/job-list-item.dto'), { JobListItemDto: {} }],
                [import('./resources/job/dto/list-jobs.dto'), { ListJobsDto: {} }],
                ...
                [import('./resources/min-wage/dto/update-min-wage.dto'), { UpdateMinWageDto: {} }],
                [
                ...
                [
                    import('./resources/pay-fund/dto/create-pay-fund.dto'),
                    {
                        CreatePayFundDto: {
                            positionId: { required: true, type: () => String },
                            payPeriod: { required: true, type: () => Date },
                ...
                [
                    import('./resources/payment-type/dto/create-payment-type.dto'),
                    {
                ...
                [import('./resources/person/events/base/person-event.abstract'), { PersonEvent: {} }],
                [
                    import('./resources/person/dto/person-search.dto'),
                    {
                        PersonSearchDto: {
                ...
                [
                    import('./resources/person/dto/person-filters.dto'),
                    {
                        PersonFiltersDto: {
                            birthDate: { required: false },
                            gender: { required: false, enum: t['./types/lib/gender'].Gender, isArray: true },
                        },
                    },
                ],
                [
                    import('./resources/person/dto/list-persons-query.dto'),
                    {
                        ListPersonsQueryDto: {
                            search: {
                                required: false,
                                type: () => t['./resources/person/dto/person-search.dto'].PersonSearchDto,
                            },
                            filters: {
                                required: false,
                                type: () => t['./resources/person/dto/person-filters.dto'].PersonFiltersDto,
                            },
                            sorting: {
                                required: false,
                                type: () => t['./resources/common/dto/sorting.dto'].SortingDto,
                            },
                            page: { required: false, type: () => t['./resources/common/dto/page.dto'].PageDto },
                        },
                    },
                ],
                [import('./resources/person/dto/list-persons.dto'), { ListPersonsDto: {} }],
                [
                ...
                [
                    import('./processor/payment-calculation/calc-methods/base/calc-payment.abstract'),
                    { CalcPayment: {} },
                ],
                [
                    import('./processor/payroll-calculation/calc-methods/base/calculate-payroll.abstract'),
                    {
                        CalculatePayroll: {
                            toInsert: {
                                required: true,
                            ...
                            toDeleteIds: { required: true, type: () => [String] },
                        },
                    },
                ],
                [
                    import('./resources/audit-log/entities/audit-log.entity'),
                    {
                        AuditLogEntity: {
                            id: { required: true, type: () => String },
                            aggregateType: { required: true, type: () => String },
                            aggregateId: { required: true, type: () => String },
                            action: { required: true, enum: t['./types/lib/audit-action'].AuditAction },
                            diff: { required: false, type: () => Object },
                            userId: { required: true, type: () => String },
                ...
                [
                    import('./resources/user-role/dto/user-role-filters.dto'),
                    {
                        UserRoleFiltersDto: {
                ...
                [import('./resources/user-role/dto/list-user-roles-query.dto'), { ListUserRolesQueryDto: {} }],
                [
                    import('./resources/user-role/dto/user-role-read.dto'),
                    {
                        UserRoleReadDto: {
                            id: { required: true, type: () => String },
                            userId: { required: true, type: () => String },
                ...
                [import('./resources/user-role/dto/user-role-list-item.dto'), { UserRoleListItemDto: {} }],
                [import('./resources/user-role/dto/list-user-roles.dto'), { ListUserRolesDto: {} }],
            ],
            controllers: [
                [
                    import('./resources/user-role/user-role.controller'),
                    {
                        UserRoleController: {
                            create: { type: String },
                            findAll: { type: [t['./resources/user-role/entities/user-role.entity'].UserRole] },
                            findOne: { type: t['./resources/user-role/entities/user-role.entity'].UserRole },
                            update: {},
                            remove: {},
                            restore: {},
                            hasGlobalRole: { type: Boolean },
                        },
                    },
                ],
                [
                    import('./resources/user-access/user-access.controller'),
                    { UserAccessController: { canUser: { type: Boolean } } },
                ],
                [
                ...
                [
                    ...
                    {
                        RoleController: {
                            create: { type: t['./resources/role/entities/role.entity'].Role },
                            findAll: { type: [t['./resources/role/entities/role.entity'].Role] },
                            findOne: { type: t['./resources/role/entities/role.entity'].Role },
                            update: {},
                            remove: {},
                            restore: {},
                        },
                ...
                [
                    import('./resources/company/company.controller'),
                    {
                        CompanyController: {
                            ...
                            remove: {},
                            restore: {},
                            findAll: { type: t['./resources/company/dto/list-companies.dto'].ListCompaniesDto },
                            findLast: { type: t['./resources/company/dto/company-read.dto'].CompanyReadDto },
                            findOne: { type: t['./resources/company/dto/company-read.dto'].CompanyReadDto },
                            salaryCalculate: {},
                        },
                    },
                ],
                [
                    ...
                    {
                        UserController: {
                            create: { type: t['./resources/user/dto/public-user-data.dto'].PublicUserDataDto },
                            findAll: { type: [t['./resources/user/dto/public-user-data.dto'].PublicUserDataDto] },
                            findCurrent: { type: t['./resources/user/dto/public-user-data.dto'].PublicUserDataDto },
                            findOne: { type: t['./resources/user/dto/public-user-data.dto'].PublicUserDataDto },
                            update: { type: t['./resources/user/dto/public-user-data.dto'].PublicUserDataDto },
                            remove: { type: t['./resources/user/dto/public-user-data.dto'].PublicUserDataDto },
                        },
                    },
                ],
                [
                    import('./resources/department/department.controller'),
                    {
                        DepartmentController: {
                            ...
                            remove: {},
                            restore: {},
                            findAll: { type: t['./resources/department/dto/list-departments.dto'].ListDepartmentsDto },
                            findOne: { type: t['./resources/department/dto/department-read.dto'].DepartmentReadDto },
                        },
                    },
                ],
                [
                    import('./resources/job/job.controller'),
                    {
                        JobController: {
                            ...
                            remove: {},
                            restore: {},
                            findAll: { type: t['./resources/job/dto/list-jobs.dto'].ListJobsDto },
                            findOne: { type: t['./resources/job/dto/job-read.dto'].JobReadDto },
                        },
                    },
                ],
                [
                ...
                [
                    import('./resources/payment-type/payment-type.controller'),
                    {
                        PaymentTypeController: {
                            create: { type: String },
                            findAll: { type: [t['./resources/payment-type/entities/payment-type.entity'].PaymentType] },
                ...
                [
                    ...
                    {
                        PersonController: {
                            create: { type: t['./resources/common/dto/id.dto'].IdDto },
                            update: {},
                            remove: {},
                            restore: {},
                            findOne: { type: t['./resources/person/dto/person-read.dto'].PersonReadDto },
                            findAll: { type: t['./resources/person/dto/list-persons.dto'].ListPersonsDto },
                        },
                    },
                ],
                [
                ...
                [
                    import('./resources/audit-log/audit-log.controller'),
                    { AuditLogController: { findAll: { type: String }, findOne: { type: String } } },
                ],
            ],
        },
    };
