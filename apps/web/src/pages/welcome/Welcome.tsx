...
import { Box, CssBaseline, IconButton, SvgIcon, Typography, useMediaQuery } from '@mui/material';
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Box id="features" sx={{ display: 'flex', flex: 1 }}>
                        Features
                    </Box>
                    <Box
                        id="footer"
                    ...
                    >
                        <Box id="footer__left" sx={{ flex: 1, my: 'auto' }}>
                            <Link
                                to="https://untilov-com-ua.vercel.app/"
                                target="_blank"
                                rel="noreferrer"
                            >
