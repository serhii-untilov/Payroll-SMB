...
import { useMandatoryPayments } from '../hooks/useMandatoryPayments';
...
export function MandatoryPayments(_props: Props) {
    ...
    const { columns, onAddPayment, onDeletePayment, onEditPayment, onPrint, onExport } =
        useMandatoryPayments(gridRef);
